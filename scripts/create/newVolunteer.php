...
$sql1 = "insert into volunteers (firstName, lastName, email, phoneNumber, idShift) values ('". $_POST["firstName"] ."', '". $_POST["lastName"] ."', '". $_POST["email"] ."', '". $_POST["phoneNumber"] ."', '". $_POST["shiftId"] ."')";
